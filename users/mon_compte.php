        ...
        <form class="needs-validation" novalidate action="" method="post">
            <div class="row">
                <div class="col-md-12 col-sm-12 mb-3">
                    ...
                    <input type="text" class="form-control" id="nom" required value="<?php echo htmlspecialchars($user_info['username']); ?>" name="nom">
                ...
                <div class="col-md-12 col-sm-12 mb-3">
                    <button class="btn btn-primary py-3 ps-2 text-white text-uppercase font-14 btn-responsive">
