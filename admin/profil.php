...
<div class="main-container mt-3 pb-5">
   ...
   <div class="col-md-12 col-sm-12 mb-3">
    ...
    <div class="card shadow-sm border-0 p-3 text-center rounded-2 d-flex flex-column align-items-center justify-content-center">
        ...
        <?php if (!empty($admin_info['photo'])): ?>
            <img id="profile-img" src="../uploads/<?php echo htmlspecialchars($admin_info['photo']); ?>" 
                ...
                class="rounded-circle img-thumbnail img-account-profile mb-3">
        <?php else: ?>
        ...
        <input type="file" class="form-control-file mt-2 text-center" name="new_photo" accept="image/*" onchange="previewImage(event)" id="file-input" style="display: block;">
    </div>

            </div>
            <div class="col-md-6">
                <div class="card shadow-sm border-0 p-3 p-3">
